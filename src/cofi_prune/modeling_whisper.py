...
class SparseWhisperPositionalEmbedding(nn.Embedding):
    ...
    def __init__(self, config):
        ...
        self.LayerNorm = SparseLayerNorm(
...
class SparseWhisperEncoder(WhisperPreTrainedModel):
    """
    Transformer encoder consisting of *config.encoder_layers* self attention layers. Each layer is a
    [`WhisperEncoderLayer`].
...
class SparseWhisperDecoder(WhisperPreTrainedModel):
    """
    Transformer decoder consisting of *config.decoder_layers* layers. Each layer is a [`WhisperDecoderLayer`]
...
class SparseWhisperModel(WhisperPreTrainedModel):
    def __init__(self, config: SparseWhisperConfig):
        super().__init__(config)
...
class SparseWhisperForConditionalGeneration(WhisperPreTrainedModel):
    base_model_prefix = "model"
    _tied_weights_keys = ["proj_out.weight"]
