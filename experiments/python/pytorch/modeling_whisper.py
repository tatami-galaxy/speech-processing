...
class WhisperEncoder(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        inputs_embeds = nn.functional.relu(self.conv1(input_features))
        inputs_embeds = nn.functional.relu(self.conv2(inputs_embeds))
...
class WhisperForConditionalGeneration(WhisperPreTrainedModel):
    ...
    def __init__(self, config: WhisperConfig):
        ...
        warnings.warn('changed gelu to relu in WhisperEncoder.forward')
